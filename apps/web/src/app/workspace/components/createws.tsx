  ...
  return (
    <>
      <div className="">
        ...
        <div className="h-full lg:w-full md:w-fit mx-auto relative">
          {/* card */}
          <form
            action=""
          ...
          >
            <div className="py-2 flex flex-col justify-around items-start">
              ...
              <div className="flex flex-col w-4/5 mx-auto py-1 mt-3">
                <label
              ...
              <div className="flex flex-col w-4/5 mx-auto py-1 mt-3">
                ...
                >
                  ...
                  <option value="B2B">B2B Tech Startups</option>
                  <option value="D2C">D2C E-Commerce</option>
                  <option value="MA">Marketing Agencies</option>
                  <option value="SA">Software Agencies</option>
              ...
              <div className="flex flex-col w-full mx-auto py-1 mt-3">
                <button
              ...
              {/*Submit Button*/}
              <div className="flex flex-col w-4/5 mx-auto py-1 mt-4">
                <button
                  disabled={isLoading}
                  type="submit"
