...
router.route("/googleurl").get(controllers_1.oauthHanlder).get(middleware_1.requireAuth, controllers_1.oauthHanlder);
router.route("/google/connect/url").get(middleware_1.requireAuth, controllers_1.oauthHanlder);
router.route("/google/connect").post(middleware_1.requireAuth, oAuthController_1.googleConnectHandler);
